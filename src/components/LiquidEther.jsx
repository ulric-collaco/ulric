...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      init(container) {
        this.container = container
        // Listen on window so we still get events even if the canvas sits behind content
      ...
      onDocumentMouseMove(event) {
        ...
        // Track whether pointer is inside the container bounds
        if (this.container) {
